        ...
        1: [function (t, e, a) {
                ...
                t.defaults.bar = {
                    ...
                    updateElement: function (t, a, i, n) {
                        var o = this, r = o.getMeta(), l = o.getScaleForId(r.xAxisID), s = o.getScaleForId(r.yAxisID),
                            d = l.getBasePixel(), u = t.custom || {}, c = o.getDataset(),
                ...
                a.doughnut = {
                    ...
                    dataElementType: t.elements.Arc, linkScales: e.noop, getRingIndex: function (t) {
                        ...
                        var n = this, o = n.chart, r = o.chartArea, l = o.options, s = l.animation,
                            d = (l.elements.arc, (r.left + r.right) / 2), u = (r.top + r.bottom) / 2, c = l.rotation,
                            h = l.rotation, f = n.getDataset(),
            ...
            e.exports = function (t) {
                ...
                t.defaults.line = {
                    ...
                    calculatePointY: function (t, e, a, i) {
                        var n, o, r, l = this, s = l.chart, d = l.getMeta(), u = l.getScaleForId(d.yAxisID), c = 0,
                            h = 0;
            ...
            e.exports = function (t) {
                ...
                t.defaults.polarArea = {
                    ...
                    dataElementType: t.elements.Arc, linkScales: e.noop, update: function (t) {
                        ...
                        var x = -.5 * Math.PI, y = t.hidden ? 0 : u.getDistanceFromCenterForValue(l.data[a]),
                            k = x + f * m, S = k + (t.hidden ? 0 : f),
            ...
            e.exports = function (t) {
                ...
                t.Title = t.Element.extend({
                    ...
                    beforeFit: a,
                    fit: function () {
                        var a = this, i = (a.ctx, e.getValueOrDefault), n = a.options, o = t.defaults.global,
                            r = n.display, l = i(n.fontSize, o.defaultFontSize), s = a.minSize;
            ...
            e.exports = function (t) {
                var e = t.helpers, a = {
                    ...
                    determineDataLimits: function () {
                        ...
                        var a = this, i = a.options, n = (i.ticks, a.chart), o = n.data, r = o.datasets,
                            l = a.isHorizontal();
            ...
            e.exports = function (t) {
                ...
                t.LinearScaleBase = t.Scale.extend({
                    handleTickRangeOptions: function () {
                        ...
                        var t = this, a = t.options, i = a.ticks, n = e.getValueOrDefault,
                            o = (t.isHorizontal(), t.ticks = []), r = t.getTickLimit();
                        r = Math.max(2, r);
